...
typedef struct
{
	vu16 LCD_REG;//LCD->LCD_REG=CMD; //写命令 //CMD= LCD->LCD_REG;//读 LCD 寄存器
	vu16 LCD_RAM;//LCD->LCD_RAM=DATA; //写数据 //DATA = LCD->LCD_RAM;//读 LCD 数据
} LCD_TypeDef;
//使用NOR/SRAM的 Bank1.sector4,地址位HADDR[27,26]=11 A6作为数据命令区分线 
//注意设置时STM32内部会右移一位对其! 111 1110=0X7E			    
#define LCD_BASE        ((u32)(0x6C000000 | 0x0000007E))//A6的偏移量是0x0000007E（可以操作A6在0/1间变化，即操作RS）
